...
### Storage
Create a namespace for storage deployment: ("storage" is the name that we are giving to this namespace)
```
kubectl create namespace storage
```

Add the chart for the nfs-provisioner usign Helm. 
Helm is a package manager for kubernetes where the "charts" are the packages.
```
